#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2022/4/27 13:10
# @Author  : 颜国进
# @File    : main_resnet50_int8_openvino.py.py
# @Software: PyCharm
# @function: 将ResNet50模型梁欢为int8
...
compressed_model_paths = save_model(model=compressed_model, save_path="D:/", model_name="quantized_mobilenet_v2"
)
